...
const WHATSAPP_CONSENT_TEXT = 'Aceito receber mensagens da RPG Capital pelo WhatsApp no número informado, incluindo mensagens relacionadas à minha conta, operação da loja, alertas e atendimento. Posso cancelar esse consentimento a qualquer momento.'
