...
const demoInvoice = {
  ...
  number: '900001',
  issuedAt: '2026-08-28T08:00:00-03:00',
  supplierName: 'DISTRIBUIDORA FICTICIA DE TESTES LTDA',
  supplierDocument: '12345678000190',
  items: [
    { line: 1, supplierCode: 'MOCA395', barcode: '7891000100103', description: 'LEITE COND MOCA 395G', quantityMilli: 12000, unitCostCents: 642, totalCents: 7704 },
    { line: 2, supplierCode: 'CC2L', barcode: '', description: 'REFRI COCACOLA2L', quantityMilli: 6000, unitCostCents: 720, totalCents: 4320 },
    { line: 3, supplierCode: 'TESTESEMGTIN', barcode: '', description: 'BISC CHOC 90G TESTE', quantityMilli: 10000, unitCostCents: 280, totalCents: 2800 },
  ],
}
...
export async function GET(request: NextRequest) {
  ...
  if (key === DEMO_NFE_ACCESS_KEY) {
    return NextResponse.json({ ok: true, demo: true, invoice: demoInvoice })
  }
